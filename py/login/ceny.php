...
<div class="box">
      ...
      <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
        ...
        <div class="row">
          <div class="col-sm-8"> <a href="ceny.php" style="text-decoration: none; color: black;">Цены и оплата</a> </div>

          <div class="col-sm-4"> <a href="#" style="text-decoration: none; color: black;">Политика конфедициальности</a> </div>
        </div>
        <div class="row">
          <div class="col-sm-8"> <a href="garant.php" style="text-decoration: none; color: black;">Гарантии</a> </div>
